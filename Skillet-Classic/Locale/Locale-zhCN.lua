...
L["CLAMPTOSCREENDESC"] = "强制保持框体在屏幕上"
L["CLAMPTOSCREENNAME"] = "将框体限制在屏幕范围内"
L["Clear"] = "清除"
L["Click"] = "点击"
...
L["DISPLAYSHOPPINGLIST"] = "在以下位置显示购物清单："
...
L["Enabled"] = "启用"
L["Enchant"] = "附魔"
L["ENCHANTSCROLLSDESC"] = "使用附魔卷轴物品作为链接"
L["ENCHANTSCROLLSNAME"] = "使用附魔卷轴"
--[[Translation missing --]]
...
L["Filter"] = "筛选"
L["Filter recipes by source"] = "按来源筛选配方"
L["FLASHONEMPTYQUEUEDESC"] = "当队列为空时图标闪烁"
L["FLASHONEMPTYQUEUENAME"] = "当队列为空时闪烁"
L["FLASHONREMOVEQUEUEDESC"] = "当队列中条目被移除时图标闪烁"
L["FLASHONREMOVEQUEUENAME"] = "移除队列条目时闪烁"
L["Flat"] = "不分組"
...
L["HIGHERVELLUMDESC"] = "在正确的羊皮纸不可用时使用更高级的羊皮纸。"
L["HIGHERVELLUMNAME"] = [=[使用更高级的羊皮纸
]=]
L["Ignore"] = "忽略"
L["Ignore on hand"] = "忽略背包（和银行）中的物品"
L["IGNOREBANKEDREAGENTSDESC"] = "在排队制造材料时忽略银行中的材料"
L["IGNOREBANKEDREAGENTSNAME"] = "忽略银行中的材料"
L["IGNORECHANGEDESC"] = "忽略第一次专业更改"
L["IGNORECHANGENAME"] = "忽略第一次专业更改"
...
L["IGNOREQUEUEDREAGENTSDESC"] = "忽略制作队列中的材料"
L["IGNOREQUEUEDREAGENTSNAME"] = "忽略制作队列中的材料"
L["Illusions"] = "幻象"
L["in your bank"] = "在银行"
...
L["INTERRUPTCLEARDESC"] = "当移动、跳跃、关闭框体或点击暂停按钮时清除正在进行的队列条目"
L["INTERRUPTCLEARNAME"] = "打断制作施法会清除队列条目"
L["inventory"] = "库存"
L["Inventory"] = "背包"
...
L["Queues"] = "队列管理"
L["QUEUETOOLSDESC"] = "将缺失的工具添加到购物清单"
L["QUEUETOOLSNAME"] = "排队工具"
...
L["Retrieve"] = "收回"
L["Right-Click for filtering options"] = "右键点击以显示筛选选项"
L["Sales for "] = "售卖情况"
L["Sales Rate"] = "售卖速度"
L["Same faction"] = "同阵营"
L["Save"] = "储存"
...
L["Selection"] = "选项"
L["SELECTTOPRECIPEDESC"] = "预先选择高级配方"
L["SELECTTOPRECIPENAME"] = "选择高级配方"
L["Sellout"] = "售罄"
L["Sells for "] = "售得"
L["Set Favorite"] = "收藏"
...
L["Show News"] = "显示更新信息"
L["Show news when a new version is released"] = "在新版本发布时显示更新信息"
...
L["SORTDESC"] = "递增排序"
L["Sorting"] = "排序"
L["SOUNDONEMPTYQUEUEDESC"] = "当队列为空时播放声音"
L["SOUNDONEMPTYQUEUENAME"] = "队列为空时的声音"
L["SOUNDONREMOVEQUEUEDESC"] = [=[当队列中的条目被移除时播放声音
]=]
L["SOUNDONREMOVEQUEUENAME"] = "移除队列条目时的声音"
L["Source:"] = "来源:"
...
L["Unknown"] = "未知"
L["Unlearned"] = "未学会"
L["Use Action Bar button to change professions"] = "使用动作条按钮切换专业"
L["USEALTBANKSDESC"] = "计算可制作数量时包括角色的银行物品"
L["USEALTBANKSNAME"] = "使用角色的银行物品"
L["USEALTCURRVENDITEMSDESC"] = "用其他货币购买的供应商物品被认为是供应商提供的。"
L["USEALTCURRVENDITEMSNAME"] = "使用其他货币购买的供应商物品"
L["USEBANKASALTDESC"] = "将银行中的物品视为另一个备用角色来使用。"
L["USEBANKASALTNAME"] = "将银行用作另一个角色"
